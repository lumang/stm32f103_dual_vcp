...
static uint8_t  USBD_CDC_Setup (USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
  ...
  case USB_REQ_TYPE_CLASS :
    if (req->wLength)
    {
      ...
      {
        ((USBD_CDC_ItfTypeDef *)pdev->pUserData)->Control(req->bRequest, (uint8_t *)hcdc->data, req->wLength, req->wIndex);
    ...
    {
      ((USBD_CDC_ItfTypeDef *)pdev->pUserData)->Control(req->bRequest, (uint8_t*)req, 0, req->wIndex);
    }
    break;
